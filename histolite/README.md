...
- Pagina **Utility**: salute di `statistics`/`statistics_short_term` (orfani, duplicati, righe future) e **ri-associazione** della storia di un sensore sostituito a quello nuovo
